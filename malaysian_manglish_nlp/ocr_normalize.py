...
import re
from malaysian_manglish_nlp.dictionary import is_malay, is_english
...
def _is_numeric_context(text: str, pos: Any) -> bool:
...
def fix_malay_ocr(text: str) -> str:
...
def _fix_bm_ocr_patterns(text: str) -> str:
    ...
    def _try_rn_fix(match: Any) -> str:
        """Internal helper for try rn fix.
...
def _try_split_merged(word: str) -> List[str]:
...
def _fix_number_letter_confusion(text: str) -> str:
    """Fix number/letter confusion in numeric contexts."""
    corrections = []

    def _replace_num(match: Any) -> str:
        """Internal helper for replace num.
...
def _fix_num_letter(fragment: Any) -> str:
...
def _fix_punctuation_spacing(text: str) -> str:
    ...
    def _add_space(match: Any) -> str:
        """Internal helper for add space.
