...
class ManglishTokenizer:
    """Custom spaCy tokenizer that uses malaysian_manglish_nlp's tokenizer."""
    ...
    def __call__(self, text: str) -> Any:
        """Tokenize text using malaysian_manglish_nlp tokenizer and return a spaCy Doc."""
...
if SPACY_AVAILABLE:
    ...
    def create_normalizer(nlp: Any, name: str) -> Any:
    ...
    def create_language_detector(nlp: Any, name: str) -> Any:
    ...
    class ManglishLanguage(Language):
        ...
        def __init__(self, vocab: Any = True, **kwargs: Any) -> None:
...
class ManglishNormalizerComponent:
    ...
    def __init__(self, nlp: Any, name: str) -> None:
...
class ManglishNERComponent:
    ...
    def __call__(self, doc: Any) -> Any:
        ...
        # Get NER results from malaysian_manglish_nlp
...
class ManglishPOSComponent:
    ...
    # Mapping from malaysian_manglish_nlp POS tags to Universal POS tags
    POS_MAP = {
        "NOUN": "NOUN",
        "VERB": "VERB",
        "ADJ": "ADJ",
    ...
    def __call__(self, doc: Any) -> Any:
        ...
        # Get POS tags from malaysian_manglish_nlp
...
def create_manglish_nlp(components: Optional[Any] = None) -> Any:
