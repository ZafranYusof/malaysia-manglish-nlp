...
Provides the same API as ``malaysian_manglish_nlp.tokenizer`` but uses a compiled C
...
Usage::
    ...
    from malaysian_manglish_nlp.tokenizer_fast import tokenize, split_sentences, normalize
...
try:
    from malaysian_manglish_nlp._tokenizer_fast import (
