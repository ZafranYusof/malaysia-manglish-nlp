...
def _find_pronouns(text: str) -> List[str]:
...
def _is_compatible(pronoun_info: Any, entity_info: Any) -> bool:
...
def _resolve_pronoun(pronoun_info: Any, entities: List[str], pronoun_position: int) -> Optional[str]:
