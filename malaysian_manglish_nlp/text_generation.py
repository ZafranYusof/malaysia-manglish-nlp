...
def _generate_synthetic_corpus(n_sentences: int = 3000, seed: Any = 42) -> List[str]:
...
def _save_model(model: Any, path: Optional[str] = None) -> None:
...
def _load_model(path: Optional[str] = None) -> Any:
...
def _get_next_word_probs(context: str, model: Any, temperature: Any = 1.0) -> Dict[str, float]:
...
def _sample_word(probs: Any, rng: Optional[Any] = None) -> str:
