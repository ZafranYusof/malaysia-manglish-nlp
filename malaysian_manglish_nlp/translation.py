"""Rule-based translation between BM, EN, and Manglish. Zero dependencies beyond malaysian_manglish_nlp."""
...
from malaysian_manglish_nlp.normalize import normalize as normalize_shortforms
...
def _translate_phrase_check(text_lower: str, phrase_dict: str) -> str:
...
def _compute_confidence(original_words: str, translated_words: str) -> float:
...
def _translate_to_english(text_lower: str, source: str) -> str:
...
def _translate_to_malay(text_lower: str, source: str) -> str:
...
def _translate_to_formal(text: str) -> str:
