...
import re
from manglish_nlp.spelling import correct_word, _BM_DICTIONARY
...
def _trigram_score(word1, word2, word3):
...
def correct_contextual(text, max_distance=2):
