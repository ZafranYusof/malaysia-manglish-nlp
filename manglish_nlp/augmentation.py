...
def vowel_alternate(word, threshold=0.5):
...
def replace_similar_vowels(word, threshold=0.5):
...
def replace_similar_consonants(word, threshold=0.5):
...
def augment(text, methods=None, n=5):
