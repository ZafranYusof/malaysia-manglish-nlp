"""
manglish_nlp.hate_speech - Hate speech detection for Malaysian context.
...
Usage:
    from manglish_nlp.hate_speech import detect_hate_speech, is_hate_speech
...
def _check_neutral_context(text):
...
def _find_group_references(text):
...
def _determine_severity(hate_patterns):
...
def _compute_confidence(group_refs, hate_patterns, is_food_ctx, is_neutral_ctx):
...
def _generate_explanation(category, severity, hate_patterns, group_refs):
