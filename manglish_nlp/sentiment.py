...
import re
from manglish_nlp.utils import get_positive_words, get_negative_words, get_intensifiers, get_negators
...
def _normalize_elongated_word(word):
...
def _detect_sarcasm_quick(text, words):
