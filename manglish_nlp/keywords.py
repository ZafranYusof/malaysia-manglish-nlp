...
def extract_keywords(text, top_n=10, method='frequency'):
...
def _tfidf_keywords(text, top_n):
    """TF-IDF-inspired extraction (treats sentences as documents)."""
    from manglish_nlp.tokenizer import sentence_tokenize
...
def _textrank_keywords(text, top_n, window=4):
