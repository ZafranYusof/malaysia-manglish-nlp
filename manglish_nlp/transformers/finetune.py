...
Usage:
    python -m manglish_nlp.transformers.finetune
    
    # Or programmatically:
    from manglish_nlp.transformers.finetune import train
...
def train(data_path='datasets/manglish_labeled.jsonl', output_dir='resources/manglish_finetuned',
