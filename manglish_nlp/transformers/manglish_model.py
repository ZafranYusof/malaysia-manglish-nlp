...
Usage:
    from manglish_nlp.transformers.manglish_model import load_model, predict
...
def load_model(model_dir=None):
    ...
    from manglish_nlp.transformers.finetune import ManglishMultiTaskModel
    ...
    if not os.path.exists(model_path):
        raise FileNotFoundError(
            ...
            f"Train first: python -m manglish_nlp.transformers.finetune\n"
...
def predict_batch(texts, model_dir=None, batch_size=32):
...
def demo_predict(text):
    ...
    Uses existing manglish_nlp sentiment and emotion modules for a
    ...
    try:
        from manglish_nlp.sentiment import analyze as sentiment_analyze
    ...
    try:
        from manglish_nlp.emotion import detect as emotion_detect
