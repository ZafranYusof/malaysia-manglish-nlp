"""
manglish_nlp.topic - Topic modeling for Manglish text.
...
Usage:
    from manglish_nlp.topic import classify_topic, classify_topics
...
def _compute_score(matches, total_keywords, text_length):
    """
...
def classify_topics(text, top_n=3):
    """
