...
def detect_language(text):
    ...
    Example:
        >>> manglish_nlp.detect_language("aku nak pergi makan")
        {'language': 'bm', 'bm_ratio': 1.0, 'en_ratio': 0.0, ...}
        >>> manglish_nlp.detect_language("I want to eat some food")
        {'language': 'en', 'bm_ratio': 0.0, 'en_ratio': 0.667, ...}
        >>> manglish_nlp.detect_language("aku nak go makan then balik la")
        {'language': 'manglish', ...}
    """
