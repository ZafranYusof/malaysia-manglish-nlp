...
def tune_sentiment_threshold(test_data, thresholds=None):
    """
...
def tune_all_modules(test_data_path):
    """
    ...
    for item in data:
        ...
        try:
            result = manglish_nlp.detect_dialect(text)
...
def generate_confusion_matrix(module, test_data):
    """
    ...
    module_config = {
        'sentiment': {
            'func': manglish_nlp.sentiment,
            'field': 'sentiment',
            'result_key': 'sentiment',
        },
        'language': {
            'func': manglish_nlp.detect_language,
            'field': 'language',
            'result_key': 'language',
        },
        'emotion': {
            'func': manglish_nlp.detect_emotion,
            'field': 'emotion',
            'result_key': 'emotion',
        },
        'dialect': {
            'func': manglish_nlp.detect_dialect,
            'field': 'dialect',
            'result_key': 'dialect',
        },
        'intent': {
            'func': manglish_nlp.classify_intent,
            'field': 'intent',
            'result_key': 'intent',
        },
    }
...
def print_report(results, suggestions=None):
...
def run_full_tuning(data_path=None):
    """
