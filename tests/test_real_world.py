"""Real-world validation tests for manglish_nlp.
...
class TestSentimentRealWorld:
    ...
    def test_coverage(self):
        ...
        results = [manglish_nlp.sentiment(t) for t in self.texts]
        non_neutral = sum(
            1 for r in results
...
class TestNormalizeRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.normalize(text)
            assert result is not None
...
class TestTokenizeRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.tokenize(text)
            assert result is not None
...
class TestCleanRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.clean(text)
            assert result is not None
            assert isinstance(result, str)
...
class TestPOSTagRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.pos_tag(text)
            assert result is not None
...
class TestNERRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.ner_tag(text)
            assert result is not None
...
class TestPipelineRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts[:50]:  # Pipeline is heavier, test subset
            result = manglish_nlp.analyze(text)
            assert result is not None
            assert isinstance(result, dict)
...
class TestHateSpeechRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for text in self.texts:
            result = manglish_nlp.detect_hate_speech(text)
            assert result is not None
...
class TestSummarizationRealWorld:
    ...
    def test_no_crashes(self):
        ...
        for i in range(0, min(20, len(texts)), 5):
            ...
            result = manglish_nlp.summarize(combined)
            assert result is not None
...
class TestTranslationRealWorld:
    ...
    def test_no_crashes_to_english(self):
        ...
        for text in self.texts[:30]:
            result = manglish_nlp.to_english(text)
            assert result is not None
            assert isinstance(result, str)
    ...
    def test_no_crashes_to_malay(self):
        ...
        for text in self.texts[:30]:
            result = manglish_nlp.to_malay(text)
            assert result is not None
            assert isinstance(result, str)
